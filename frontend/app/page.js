      ...
      <div style={{background:"linear-gradient(180deg,#1a0810,#0d0520)",border:"1px solid rgba(232,100,10,0.3)",borderRadius:"24px 24px 0 0",padding:"22px 20px",width:"100%",maxWidth:"480px",maxHeight:"92vh",overflowY:"auto"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"20px"}}>
          <div>
            ...
            <p style={{color:"#aa7788",fontSize:"0.7rem",marginTop:"2px"}}>Support your favourite artist ✨</p>
          </div>
        ...
        <div style={{textAlign:"center",padding:"20px 0 16px"}}>
          ...
          <h3 style={{fontWeight:"900",fontSize:"1.2rem",marginBottom:"10px",background:"linear-gradient(90deg,#E8640A,#D4006A)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Coming Soon!</h3>
          <p style={{color:"#aa7788",fontSize:"0.85rem",lineHeight:"1.7",marginBottom:"22px"}}>
            The gifting feature is being set up and will be available very soon — stay tuned! 🎵
          </p>
          <div style={{background:"rgba(232,100,10,0.07)",border:"1px solid rgba(232,100,10,0.2)",borderRadius:"12px",padding:"14px",marginBottom:"22px",textAlign:"left"}}>
            <p style={{color:"#E8640A",fontWeight:"700",fontSize:"0.8rem",marginBottom:"6px"}}>Coming features:</p>
            <p style={{color:"#aa7788",fontSize:"0.75rem",lineHeight:"2.0"}}>
              💰 Mobile Money gifting (MTN &amp; Airtel)<br/>
              🎫 Gift card support<br/>
              🎁 Your name shown on the artist&apos;s music
            </p>
          </div>
          <button onClick={onClose} style={{width:"100%",padding:"14px",borderRadius:"12px",background:"linear-gradient(135deg,#E8640A,#D4006A)",color:"#fff",fontWeight:"800",fontSize:"0.95rem",border:"none",cursor:"pointer"}}>
            Got It 👍
          </button>
        </div>
      </div>
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (token && artist) setLoggedIn(true);
    } catch {}
  }, []);
      ...
      <div style={{padding:"0 18px"}}>
        ...
        <div style={{marginTop:"22px",padding:"18px",borderRadius:"14px",background:"linear-gradient(135deg,rgba(255,215,0,0.07),rgba(232,100,10,0.07))",border:"1px solid rgba(255,215,0,0.18)",textAlign:"center",marginBottom:"12px"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:"9px",alignItems:"center"}}>
            <a href="tel:+256701910974" style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"7px",padding:"10px 22px",borderRadius:"99px",background:"linear-gradient(135deg,#FFD700,#E8640A)",color:"#000",fontWeight:"800",fontSize:"0.8rem",textDecoration:"none",width:"100%",maxWidth:"260px",boxSizing:"border-box"}}>
              📞 Call to Promote ⭐
            </a>
            <div style={{display:"flex",gap:"7px",flexWrap:"wrap",justifyContent:"center"}}>
              <a href="https://wa.me/256701910974" target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:"5px",padding:"7px 12px",borderRadius:"99px",background:"rgba(37,211,102,0.12)",border:"1px solid rgba(37,211,102,0.32)",color:"#25D366",fontWeight:"700",fontSize:"0.68rem",textDecoration:"none"}}>
                💬 +256701910974
              </a>
              <a href="https://wa.me/256785393540" target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:"5px",padding:"7px 12px",borderRadius:"99px",background:"rgba(37,211,102,0.12)",border:"1px solid rgba(37,211,102,0.32)",color:"#25D366",fontWeight:"700",fontSize:"0.68rem",textDecoration:"none"}}>
                💬 +256785393540
              </a>
            </div>
            <p style={{color:"#555",fontSize:"0.63rem",marginTop:"2px"}}>Contact us via call or WhatsApp to arrange your deal</p>
          </div>
        </div>
        ...
        {/* ─── Footer ─── */}
        <div style={{marginTop:"28px",paddingTop:"20px",borderTop:"1px solid rgba(255,255,255,0.08)",textAlign:"center",paddingBottom:"16px"}}>
          <p style={{fontWeight:"900",fontSize:"0.82rem",background:"linear-gradient(90deg,#E8640A,#D4006A,#7B2FBE)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",marginBottom:"8px",lineHeight:"1.5"}}>
            CLEAN MONEY AVENUE MEDIA<br/>&amp; TECHNOLOGY LTD
          </p>
          <div style={{display:"flex",justifyContent:"center",gap:"14px",marginBottom:"9px",flexWrap:"wrap"}}>
            <a href="tel:+256701910974" style={{color:"#aa7788",fontSize:"0.7rem",textDecoration:"none",fontWeight:"600"}}>📞 +256 701 910 974</a>
            <a href="tel:+256785393540" style={{color:"#aa7788",fontSize:"0.7rem",textDecoration:"none",fontWeight:"600"}}>📞 +256 785 393 540</a>
          </div>
          <p style={{color:"#444",fontSize:"0.65rem",marginBottom:"3px"}}>© 2026 CyberMuzik. All rights reserved.</p>
          <p style={{color:"#333",fontSize:"0.58rem"}}>Powered by Clean Money Avenue Media &amp; Technology Ltd</p>
        </div>
      </div>
