  ...
  return (
    ...
    >
      ...
      <div style={{position:"absolute", bottom:0, left:0, right:0, padding:"16px"}}>
        <p style={{fontWeight:"900", fontSize:"1.1rem", fontFamily:"'Syne',sans-serif", marginBottom:"2px"}}>{track.artist}</p>
        ...
        <div style={{display:"flex", alignItems:"center", gap:"8px"}} onClick={e => e.stopPropagation()}>
          ...
          <button
            onClick={onPlay}
            style={{
              flex:1, height:"44px", borderRadius:"12px", border:"none", cursor:"pointer",
              display:"flex", alignItems:"center", justifyContent:"center", gap:"8px",
              fontWeight:"800", fontSize:"0.88rem", transition:"all 0.2s",
              background: isActive ? "linear-gradient(135deg,#00e5ff,#0077ff)" : "#fff",
              color:"#000"
            }}
          >
          ...
          <button
            onClick={handleLike}
            style={{width:"44px", height:"44px", borderRadius:"12px", border:`1px solid ${liked ? "rgba(255,71,87,0.4)" : "rgba(255,255,255,0.1)"}`, background: liked ? "rgba(255,71,87,0.2)" : "rgba(255,255,255,0.08)", cursor: liked ? "default" : "pointer", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"1rem", color:"#fff", transition:"all 0.2s"}}
          >
            {liked ? "❤️" : "🤍"}
          </button>
          ...
          <a
            ...
            style={{width:"44px", height:"44px", borderRadius:"12px", border:"1px solid rgba(255,255,255,0.1)", background:"rgba(255,255,255,0.08)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"1rem", color:"#fff", textDecoration:"none"}}
          >
            ⬇
          </a>
          ...
          <button
            onClick={handleShare}
            style={{width:"44px", height:"44px", borderRadius:"12px", border:"1px solid rgba(255,255,255,0.1)", background:"rgba(255,255,255,0.08)", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"1rem", color:"#fff"}}
          >
            🔗
          </button>
        </div>
