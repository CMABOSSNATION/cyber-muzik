  ...
  return (
    <main style={{padding:"20px", color:"white", background:"linear-gradient(160deg,#1a0810 0%,#0d0520 50%,#1a0810 100%)", minHeight:"100vh", maxWidth:"680px", margin:"0 auto", paddingBottom:"40px"}}>
      ...
      <div style={{display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:"24px"}}>
        ...
        <button onClick={handleLogout} style={{padding:"8px 16px", borderRadius:"99px", background:"rgba(255,255,255,0.05)", border:"1px solid rgba(255,255,255,0.1)", color:"#888", fontSize:"0.75rem", cursor:"pointer"}}>
          Sign Out
        </button>
      </div>
      ...
      <div style={{display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"10px", marginBottom:"16px"}}>
        <div style={{background:"rgba(232,100,10,0.1)", border:"1px solid rgba(232,100,10,0.25)", borderRadius:"12px", padding:"16px", textAlign:"center"}}>
          ...
          <div style={{fontSize:"0.65rem", color:"#aa7788", textTransform:"uppercase", letterSpacing:"0.08em", marginTop:"4px"}}>▶ Total Plays</div>
        </div>
      ...
      <div style={{display:"flex", gap:"10px", marginBottom:"24px"}}>
        ...
        <button
          onClick={() => fetchMyTracks()}
          style={{padding:"14px 16px", borderRadius:"12px", background:"rgba(255,255,255,0.05)", color:"#E8640A", fontWeight:"700", fontSize:"0.9rem", border:"1px solid rgba(232,100,10,0.3)", cursor:"pointer"}}
      ...
      {deleteId && (
        <div style={{position:"fixed", inset:0, background:"rgba(0,0,0,0.9)", display:"flex", alignItems:"center", justifyContent:"center", zIndex:999, padding:"20px"}}>
          <div style={{background:"#1a0810", border:"1px solid rgba(212,0,106,0.3)", borderRadius:"16px", padding:"24px", maxWidth:"320px", width:"100%", textAlign:"center"}}>
            ...
            <p style={{color:"#aa7788", fontSize:"0.82rem", marginBottom:"24px"}}>This cannot be undone. The track and all its stats will be permanently removed.</p>
