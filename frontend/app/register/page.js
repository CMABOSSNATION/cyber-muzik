        ...
        <div style={{display:"flex", flexDirection:"column", gap:"16px"}}>
          ...
          <div>
            ...
            <div onClick={() => document.getElementById('coverInput').click()} style={{width:"100%", height:"140px", borderRadius:"12px", background: coverPreview ? "transparent" : "#111", border:"2px dashed #222", display:"flex", alignItems:"center", justifyContent:"center", cursor:"pointer", overflow:"hidden"}}>
              {coverPreview ? <img src={coverPreview} alt="Cover" style={{width:"100%", height:"100%", objectFit:"cover"}}/> : <div style={{textAlign:"center"}}><div style={{fontSize:"2rem", marginBottom:"6px"}}>🖼️</div><p style={{color:"#555", fontSize:"0.78rem"}}>Tap to upload cover photo</p></div>}
            </div>
          ...
          <div style={{display:"flex", alignItems:"center", gap:"16px"}}>
            <div onClick={() => document.getElementById('profileInput').click()} style={{width:"80px", height:"80px", borderRadius:"50%", background: profilePreview ? "transparent" : "#111", border:"2px dashed #222", display:"flex", alignItems:"center", justifyContent:"center", cursor:"pointer", overflow:"hidden", flexShrink:0}}>
              {profilePreview ? <img src={profilePreview} alt="Profile" style={{width:"100%", height:"100%", objectFit:"cover"}}/> : <span style={{fontSize:"1.8rem"}}>👤</span>}
            </div>
            <div>
          ...
          <div style={{display:"flex", gap:"10px"}}>
            ...
            <button onClick={handleRegister} disabled={loading} style={{flex:2, padding:"14px", borderRadius:"10px", background: loading ? "#333" : "#1DB954", color: loading ? "#aaa" : "#000", fontWeight:"800", fontSize:"0.95rem", border:"none", cursor: loading ? "not-allowed" : "pointer"}}>
